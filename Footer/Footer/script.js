document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateContent(language) {
        const aboutHeader = document.querySelector(".footer-column:nth-child(1) h3");
        const linkList = document.querySelectorAll(".footer-column:nth-child(1) ul li a");
        const contactHeader = document.querySelector(".footer-column:nth-child(3) h3");
        const footerLinks = document.querySelectorAll(".footer-bottom a");
        const languageHeader = document.querySelector(".footer-column:nth-child(2) h3");
